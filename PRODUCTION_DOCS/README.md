...
- **[01_PRODUCT_STANDARDS.md](02_CONFIGURATION/01_PRODUCT_STANDARDS.md)** - Chuẩn hóa sản phẩm (4 loại DTX)
...
2. **Cấu hình ban đầu**: Đọc [02_CONFIGURATION/](02_CONFIGURATION/)
3. **Backup database**: Đọc [05_MAINTENANCE/01_BACKUP_RESTORE.md](05_MAINTENANCE/01_BACKUP_RESTORE.md)
...
- ✅ Contract Cost Tracking (chi phí hợp đồng)
...
- ✅ Cập nhật tài liệu Commission Tracking (NEW)
- ✅ Cập nhật tài liệu Advance Payment (NEW)
