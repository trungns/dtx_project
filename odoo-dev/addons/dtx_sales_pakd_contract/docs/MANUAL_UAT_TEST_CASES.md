...
- Hoặc: ⚠️ Warning "UOM khác nhau, kiểm tra lại qty"

---

### 9.3. Partial delivery, partial invoice

**Test Case 29: Complex scenario**

**Scenario**:
- Giao hàng 2 lần: 5 + 5 cây
- Invoice 2 lần: 50% + 50%
- Thanh toán 3 lần: 30% + 30% + 40%

**Actions**: Follow các steps ở phần 4, 5, 6 với partial

**Expected Result**:
- ✅ Tracking đúng từng đợt
- ✅ AR tính đúng residual
- ✅ Profit tính đúng khi hoàn thành

---

## 10. CHECKLIST TỔNG HỢP

### 10.1. Pre-Sales Checklist

- [ ] Customer/Vendor/Products đã tạo đầy đủ
- [ ] VAT taxes cấu hình đúng
- [ ] Quotation tạo thành công
- [ ] PAKD tạo được từ quotation
- [ ] PAKD formulas tính đúng (match Excel template)
- [ ] PAKD submit/approve workflow OK
- [ ] PAKD apply vào quotation thành công
- [ ] Quotation confirm → SO

### 10.2. Procurement Checklist

- [ ] PO mua linh kiện tạo được
- [ ] Receipt linh kiện vào kho
- [ ] Tồn kho tăng đúng
- [ ] Resupply/Transfer linh kiện cho đối tác
- [ ] Receipt thành phẩm về kho
- [ ] Tồn kho thành phẩm đúng

### 10.3. Deployment Checklist

- [ ] Delivery order tạo từ SO
- [ ] Validate delivery thành công
- [ ] Triển khai tại site (tracking bằng Project/Note)
- [ ] Nghiệm thu hoàn tất (biên bản ký, upload)
- [ ] Trạng thái acceptance updated

### 10.4. Finance Checklist

- [ ] Invoice tạo sau nghiệm thu
- [ ] Invoice confirm & post
- [ ] Payment register (partial/full)
- [ ] AR tracking (residual, overdue, status)
- [ ] Contract Cost import từ PAKD
- [ ] Actual cost cập nhật từ PO
- [ ] Profit/Margin tính chính xác

### 10.5. Post-Sales Checklist

- [ ] Maintenance contract active
- [ ] Support tickets tracking
- [ ] Warranty costs tracked
- [ ] Renewal opportunities

### 10.6. Reporting Checklist

- [ ] Contract List hiển thị đúng
- [ ] AR Aging report chính xác
- [ ] PAKD vs Actual comparison
...
**Vendors**:
- ABC Technology Distributor (linh kiện)
- XYZ Manufacturing Vietnam (gia công)

**Products**:
- 5 linh kiện: Raspberry Pi, Touchscreen, Camera, Enclosure, Network Kit
- 1 thành phẩm: Self-service Kiosk
- 3 dịch vụ: Assembly, Installation, Maintenance

**Orders**:
- SO001: VNPAY - 10 Kiosks - 145M VND (incl VAT)
- PAKD/2026/001: Approved, applied to SO001
- PO00001: Mua linh kiện - 89M VND
- PO00002: Dịch vụ gia công - 16.5M VND
...
| Issue | Solution |
|-------|----------|
| UOM required error khi tạo PAKD line | Đã fix: `create()` method tự động set default UOM |
| PAKD margin % hiển thị sai | Đã fix: widget="percentage" tự × 100, không nhân thêm |
| Apply wizard skip dòng không có product | Expected: wizard log warning & skip |
| AR aging bucket sai | Check SQL view, kiểm tra logic tính days overdue |

### 11.3. Performance Notes

- **Contract List**: Sử dụng computed fields với `store=True` → fast
- **AR Aging**: SQL view cho 10K+ invoices → sub-second query
- **PAKD formulas**: `@api.depends` trigger chính xác, không recompute toàn bộ

---

## 12. FEEDBACK & IMPROVEMENT

**Sau khi UAT, ghi nhận**:
- ✅ Passed test cases
- ❌ Failed test cases (bug report)
- 💡 Suggestions for improvement
- 📋 Missing features
- 🚀 Next phase requirements

**Contact**: dtx-dev-team@dtx.com

---

**END OF MANUAL UAT TEST CASES**

*Version 1.3.0 - Last updated: 2026-01-05*
